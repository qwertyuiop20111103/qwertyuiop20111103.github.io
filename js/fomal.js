...
$.ajax({
  ...
  data: {
    key: '4VQBZ-ZGO3G-VGSQE-ILN4G-LWFUK-5WB7H',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
  ...
  (function ($) {
    $.fn.nekoScroll = function (option) {
      var defaultSetting = {
        ...
        borderRadius: 5 + 'px',
        right: 55.6 + 'px',
        nekoImg: "https://picss.sunbangyan.cn/2023/12/25/3db0e23d1c19a07e5db11ddaa2f51f8f.jpeg",
        hoverMsg: "我们做错了什么~",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("12/15/2023 00:00:00");
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://pic1.zhimg.com/80/v2-e1f98520bf2727f5cba6dc022a971ccc_720w.webp);
    --darkmode-bg:url(https://pic2.zhimg.com/80/v2-6b359f4f3a91169cc198fac229e559c5_720w.webp);
    --mobileday-bg: url(https://pic4.zhimg.com/80/v2-96bd248f1adde86adec0c1bb013850e7_720w.webp);
    --mobilenight-bg: url(https://pic4.zhimg.com/80/v2-2773615cdf2305e7402655a19c7dcdef_720w.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
